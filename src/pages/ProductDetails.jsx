        ...
        <Container>
          ...
          <Col lg='6'>
            <div className="product__details">
              ...
              <motion.button whileTap={{scale : 1.2}} className="buyNow" onClick={addToCart}>Add to Cart</motion.button>
                      ...
                      <div className="review__form">
                        <h4>Leave your experience</h4>
                          <form action="" onSubmit={submitHandler}>
                            ...
                            <motion.button whileTap={{scale : 1.2}} type='submit' className="addtocart">
                              Submit
                            </motion.button>
